...
const EmployeeCard = ({name, surname, age, email, phone, seniority, departments, position, earnings, bonus, satisfaction}) => {
	return (
		<Card sx={{minWidth: 275, mt: 5}}>
          ...
          <Box>
                ...
                alignItems: 'center'
						...
						<Typography sx={{mb: 1, mt: 2}} color='text'>
							Departments: {departments.map((item, index) => index === 0 ? item : ' / ' + item)}
						</Typography>
          ...
          <Box
						...
						<CircularProgress variant='determinate' value={satisfaction} sx={{mr: 3}} />
						<Typography variant='h5' component='div'>
							{satisfaction}%
